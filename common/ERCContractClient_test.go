...
func TestERCContract(t *testing.T)  {
	keyPath := "./keys"
	...
	ContractAddress := "0x273841f3F5AC668E766c9C8fE97F09e0CA7CEf79"
	contract, err := InitERCContractClient(ContractABI,ContractAddress, client.Client)
	count, err := contract.GetBalanceOf("0xaECAC23B2bbB13748c7b507b0df8171061cE4955")
	t.Log(count)
	t.Log(err)
}
